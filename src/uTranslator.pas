...
begin
			...
			case _word of
				SECTION_START_MARKER: begin
					...
					begin
						...
						TranslateSection.err_msg :=
							'a section-start marker was encountered eventhough all sections have '
							+ 'been inserted!';
						exit;
					end;
	...
	if section^.parent = Nil then
		TranslateSection.value :=
			TranslateSection.value + generator.template.root_section_format.postfix_text
	else
		TranslateSection.value :=
			TranslateSection.value + generator.template.section_format.postfix_text;
end;
